...
[System.Serializable]
public class StingSkill : PhysicalAttackSkill, IEvolvableSkill // 찌르기
{
    ...
    public StingSkill()
        : base("찌르기", 1, 1.2, 1, SkillAttribute.Pierce)
    {
        SkillUseCount = 0;
        SkillKillCount = 0;
        SkillDamageCount = 0;
    ...
    public void EvolveSkill(CharacterData user)
    {
        ...
        SkillManager.AddSkill(user, new PierceSkill()); // 진화된 스킬로 대체
    }
}