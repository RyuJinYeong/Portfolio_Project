...
{
    public WeaponCategory Category { get; } // 무기 유형 지정 - 중량, 경량무기 구분
    ...
    public WeaponType Type { get;} // 무기 타입 - 둔기, 도검류 등등..

    public Weapon(string name, WeaponCategory category, List<WeaponTag> tags, WeaponType type, List<SkillAttribute> attribute, CharacterStats statModifiers)
