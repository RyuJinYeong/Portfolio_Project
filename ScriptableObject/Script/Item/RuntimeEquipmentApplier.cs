...
public static class RuntimeEquipmentApplier
{
    public static void ApplyRuntimeEquipmentSlots(CharacterData character, EquipmentSpawnSlotSet slotSet)
    {
    ...
    public static void ApplyRuntimeEquipments(CharacterData character, List<EquipmentSpawnData> equipments)
    {
    ...
    private static void ApplyOne(CharacterData character, EquipmentSpawnData spawnData)
    {
        ...
        EquipmentInstanceRepository.AddRuntime(generated);
